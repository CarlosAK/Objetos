...
public class Executor {
	...
	public static void main(String[] args) {
		...
		CartaoCredito novocard = new CartaoCredito(951357);
		CartaoCredito novocard2 = new CartaoCredito(159357);
		...
		Agencia novoagencia = new Agencia(1234);
		Agencia novoagencia2 = new Agencia(4321);
		...
		CartaoCredito cartao_cliente = new CartaoCredito(147369);
		...
		Agencia novaage = new Agencia(1234);
